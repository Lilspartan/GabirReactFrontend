  ...
  useEffect(() => {
    (async () => {
      ...
      for (var i = 0; i < cal.length; i ++) {
        if ((cal[i].timestamp + 25200) * 1000 > Date.now() && !done) {
          done = true;
    ...
    <>
      ...
      {!loading && (
        <>
          ...
          >
            {/* <Christmas /> */}
            <div className="uk-child-width-1-4 uk-text-center uk-position-top-center" uk-grid = "true" uk-scrollspy="cls: uk-animation-slide-top-medium; target: .fade-cd; delay: 400;" uk-countdown={`date: ` + timeConverter(next.timestamp + 25200)} uk-parallax="blur: 15;">
