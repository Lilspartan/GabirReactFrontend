const Race = ({ race }) => {
    ...
    return (
        <div>
            <div className={`uk-card uk-card-${time > race.timestamp + 25200 ? 'secondary' : 'default'} uk-card-body`}>
                ...
                <h5 className = "uk-margin-small uk-text-warning">{race.tags.notes != null ? race.tags.notes : ''}</h5>
